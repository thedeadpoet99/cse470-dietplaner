            ...
            <div className="max-w-7xl mx-auto px-4 mt-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-start">
                        <div className="flex flex-col items-start pr-8"> {/* Add right padding for text container */}
                    ...
                    <img src={slide1} alt="hometwo 1" style={{ width: '40%', height: 'auto' }} /> {/* Picture */}
                </div>
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <img src={HomeTwo2} alt="HomeTwo2" style={{ width: '40%', height: 'auto' }} /> {/* Picture */}
                </div>

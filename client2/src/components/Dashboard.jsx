    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-beige-100 to-beige-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <button className="text-lg bg-green-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105">Diet Calendar</button>
